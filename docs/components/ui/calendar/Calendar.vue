...
.vc-time-select-group {
  @apply inline-flex items-center px-1 rounded-md bg-accent border border-solid border-secondary;
}
...
.vc-time-select-group select {
  @apply bg-accent p-1 appearance-none outline-none text-center;
}
